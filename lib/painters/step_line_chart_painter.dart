...
/// Custom painter for step line charts with horizontal and vertical segments
class StepLineChartPainter extends BaseChartPainter {
  ...
  @override
  bool shouldRepaint(covariant StepLineChartPainter oldDelegate) {
