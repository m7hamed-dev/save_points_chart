      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            PieChartWidget(
              data: const [
                PieData(label: 'Mobile', value: 15, color: Color(0xFF6366F1)),
                PieData(label: 'Desktop', value: 15, color: Color(0xFF8B5CF6)),
                PieData(label: 'Tablet', value: 15, color: Color(0xFFEC4899)),
